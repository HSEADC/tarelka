(self.webpackChunkTarelka = self.webpackChunkTarelka || []).push([
  [57],
  {
    855: (t, e, r) => {
      "use strict";
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        var t = o().base("app11awHwinfj4ZoV");
        (new Promise(function (e, r) {
          ...
          (!(function (t) {
            var e = document.querySelector(".O_RecipesCards");
            e &&
              t.forEach(function (t) {
                var r = t.title,
                  n = t.tags,
                ...
                (s.classList.add("A_TitleCard"), (s.innerText = r));
                var u = document.createElement("div");
                (u.classList.add("C_ArticleTags"),
                  Array.isArray(n) &&
                    n.forEach(function (t) {
                      var e = document.createElement("span");
                      (e.classList.add("A_TagRecipes"),
                        (e.innerText = t),
                        u.appendChild(e));
                    }));
                var c = document.createElement("a");
                (c.classList.add("M_RecipesCards"),
                  i && c.classList.add(i.toLowerCase()),
                  (c.href = o),
            ...
            (function (t) {
              var e = document.querySelector(".O_RecipesCardsM");
              e &&
          ...
          new Promise(function (e, r) {
            ...
            !(function (t) {
              var e = document.querySelector(".O_ArticleCards");
              e &&
                t.forEach(function (t) {
                  var r = t.title,
                    n = t.description,
                  ...
                  (u.classList.add("A_TitleCard"), (u.innerText = r));
                  var c = document.createElement("p");
                  (c.classList.add("A_DescriptionCard"), (c.innerText = n));
                  var l = document.createElement("div");
                  if ((l.classList.add("C_ArticleTags"), o)) {
                    var f = document.createElement("span");
                    (f.classList.add("A_TagRecipes"),
                      (f.innerText = o),
                      l.appendChild(f));
                  }
                  var d = document.createElement("a");
                  (d.classList.add("M_ArticleCard"),
                    s && d.classList.add(s.toLowerCase()),
                    (d.href = a),
                    (d.style.backgroundImage = "url(".concat(i, ")")));
                  var p = document.createElement("div");
                  p.classList.add("W_ArticleTop");
                  var h = document.createElement("div");
                  (h.classList.add("A_Arrow"),
                    p.appendChild(l),
                    p.appendChild(h));
                  var _ = document.createElement("div");
                  (_.classList.add("W_ArticleText"),
                    _.appendChild(u),
                    _.appendChild(c),
                    d.appendChild(p),
                    d.appendChild(_),
      ...
      })(
        {
                ...
                o =
                  "undefined" != typeof window
                    ...
                    : "undefined" != typeof self
                      ...
                      : null;
              ((n = o
                ? "signal" in new Request("https://airtable.com")
                  ? o.AbortController
                  : t("abortcontroller-polyfill/dist/cjs-ponyfill")
                      .AbortController
                : t("abort-controller")),
                (e.exports = n));
            },
          ...
          3: [
            function (t, e, r) {
              ...
              var n =
                ...
                a = o(t("lodash/get")),
                i = o(t("lodash/isPlainObject")),
                s = o(t("lodash/keys")),
                u = o(t("./fetch")),
                c = o(t("./abort-controller")),
                l = o(t("./object_to_query_param_string")),
                f = o(t("./airtable_error")),
                d = o(t("./table")),
                p = o(t("./http_headers")),
                h = o(t("./run_action")),
                _ = o(t("./package_version")),
                b = o(t("./exponential_backoff_with_jitter")),
                y = "Airtable.js/" + _.default,
                v = (function () {
                  function t(t, e) {
                  ...
                  return (
                    (t.prototype.table = function (t) {
                      return new d.default(this, null, t);
                    }),
                    (t.prototype.makeRequest = function (t) {
                      var e,
                        r = this;
                      void 0 === t && (t = {});
                      var o = a.default(t, "method", "GET").toUpperCase(),
                        i =
                        ...
                        u.default(i, d)
                          .then(function (i) {
                            if (
                              (clearTimeout(p),
                              429 !== i.status ||
                                r._airtable._noRetryIfRateLimited)
                            )
                              i.json()
                                .then(function (t) {
                                  var n =
                                    r._checkStatusForError(i.status, t) ||
                                    g(i.status, t);
                                  n
                                    ? o(n)
                                    : e({
                              ...
                              var s = a.default(t, "_numAttempts", 0),
                                u = b.default(s);
                              setTimeout(function () {
                                var a = n(n({}, t), { _numAttempts: s + 1 });
                                r.makeRequest(a).then(e).catch(o);
                              }, u);
                            }
                          })
                          .catch(function (t) {
                    ...
                    (t.prototype.runAction = function (t, e, r, n, o) {
                      h.default(this, t, e, r, n, o, 0);
                    }),
                    ...
                    (t.createFunctor = function (e, r) {
                      ...
                      return (
                        (o._base = n),
                        (o.table = n.table.bind(n)),
                        (o.makeRequest = n.makeRequest.bind(n)),
                        (o.runAction = n.runAction.bind(n)),
                        (o.getId = n.getId.bind(n)),
                        o
                      );
                    }),
                    t
                ...
                return (
                  ...
                  function () {
                    ...
                    if (
                      ...
                      typeof o[
                        (n =
                          void 0 === r ? (o.length > 0 ? o.length - 1 : 0) : r)
                      ]
                    ) {
                      for (
                        var i = [], s = Math.max(o.length, n), u = 0;
                        u < s;
                        u++
                      )
                        i.push(o[u]);
              ...
              e.exports = function (t, e, r) {
                return function () {
                  for (var o = [], a = 0; a < arguments.length; a++)
                    o[a] = arguments[a];
                  (n[e] || ((n[e] = !0), console.warn(r)), t.apply(this, o));
                };
              };
            },
            {},
          ...
          6: [
            function (t, e, r) {
              ...
              e.exports = function (t) {
                var e =
                    n.default.INITIAL_RETRY_DELAY_IF_RATE_LIMITED *
                    Math.pow(2, t),
                ...
                o =
                  "undefined" != typeof window
                    ...
                    : "undefined" != typeof self
                      ? self
                      : null;
              e.exports = o ? o.fetch.bind(o) : n.default;
            },
            { "node-fetch": 20 },
          ],
          8: [
                  ...
                  return (
                    ...
                    (t.prototype.toJSON = function () {
                      for (
                        ...
                        var a = r[e],
                          i = this._headersByLowercasedKey[a];
                        t[
                          o && "user-agent" === a
            ...
            function (t, e, r) {
              ...
              function s(t, e, r) {
                if (o.default(e))
                  ...
                  for (var u = 0, c = i.default(e); u < c.length; u++) {
                    var l = c[u];
                    s(t + "[" + l + "]", (a = e[l]), r);
                  }
                else r(t, e);
          ...
          13: [
            function (t, e, r) {
              ...
              var n =
                ...
                a = o(t("lodash/isFunction")),
                i = o(t("lodash/keys")),
                s = o(t("./record")),
                u = o(t("./callback_to_promise")),
                c = o(t("./has")),
                l = t("./query_params"),
                f = o(t("./object_to_query_param_string")),
                d = (function () {
                  function t(t, e) {
                    ((this._table = t),
                      (this._params = e),
                      (this.firstPage = u.default(p, this)),
                      (this.eachPage = u.default(h, this, 1)),
                      (this.all = u.default(_, this)));
                  }
                  return (
                    (t.validateParams = function (e) {
                      for (
                        var r = {}, n = [], o = [], a = 0, s = i.default(e);
                        a < s.length;
                        a++
                      ) {
                        var u = s[a],
                          l = e[u];
                        if (c.default(t.paramValidators, u)) {
                          var f = (0, t.paramValidators[u])(l);
                          f.pass ? (r[u] = l) : o.push(f.error);
                        } else n.push(u);
                      }
                      return { validParams: r, ignoredKeys: n, errors: o };
                    }),
                    (t.paramValidators = l.paramValidators),
                    t
                  );
                })();
              function p(t) {
              ...
              function h(t, e) {
                ...
                var o,
                  ...
                  c =
                    "/" +
                    this._table._urlEncodedNameOrId() +
                    "?" +
                    f.default(u),
                  d = {},
                  p = null;
                if (
                  "post" === u.method ||
                  c.length > l.URL_CHARACTER_LENGTH_LIMIT
                ) {
                  ((p = u),
                    (o = "post"),
                    (i =
                      ...
                      this._table._urlEncodedNameOrId() +
                      "/listRecords"));
                  for (var h = 0, _ = Object.keys(u); h < _.length; h++) {
                    var b = _[h];
                    l.shouldListRecordsParamBePassedAsParameter(b)
                      ? (d[b] = u[b])
                      : (p[b] = u[b]);
                  }
                } else
                  ((o = "get"),
                    (d = u),
                    (i = "/" + this._table._urlEncodedNameOrId()));
                var y = function () {
                  r._table._base.runAction(o, i, d, p, function (n, o, a) {
                    if (n) e(n, null);
                    else {
                      var i = void 0;
                      a.offset
                        ? ((u.offset = a.offset), (i = y))
                        : (i = function () {
                            e(null);
                          });
                      var c = a.records.map(function (t) {
          ...
          14: [
            function (t, e, r) {
              ...
              ((r.paramValidators = {
                ...
                sort: o.default(
                  o.default.isArrayOf(function (t) {
                    return (
                      s.default(t) &&
                      a.default(t.field) &&
                      (void 0 === t.direction ||
                ...
                cellFormat: o.default(function (t) {
                  return a.default(t) && ["json", "string"].includes(t);
                }, 'the value for `cellFormat` should be "json" or "string"'),
                timeZone: o.default(
                  a.default,
                  "the value for `timeZone` should be a string",
                ),
                userLocale: o.default(
                  a.default,
                  "the value for `userLocale` should be a string",
                ),
                method: o.default(function (t) {
                  return a.default(t) && ["get", "post"].includes(t);
                }, 'the value for `method` should be "get" or "post"'),
                returnFieldsByFieldId: o.default(
                  u.default,
                  "the value for `returnFieldsByFieldId` should be a boolean",
                ),
                recordMetadata: o.default(
                  o.default.isArrayOf(a.default),
              ...
              var n =
                ...
                a = (function () {
                  function t(t, e, r) {
                    ((this._table = t),
                      (this.id = e || r.id),
                      r && (this.commentCount = r.commentCount),
                      this.setRawJson(r),
                      (this.save = o.default(i, this)),
                      (this.patchUpdate = o.default(s, this)),
                      (this.putUpdate = o.default(u, this)),
                      (this.destroy = o.default(c, this)),
                      (this.fetch = o.default(l, this)),
                  ...
                  return (
                    ...
                    (t.prototype.setRawJson = function (t) {
                      ((this._rawJson = t),
                        (this.fields =
                          (this._rawJson && this._rawJson.fields) || {}));
                    }),
                    t
                  );
                })();
          ...
          16: [
            function (t, e, r) {
              ...
              var n =
                ...
                o = n(t("./exponential_backoff_with_jitter")),
                a = n(t("./object_to_query_param_string")),
                i = n(t("./package_version")),
                s = n(t("./fetch")),
                u = n(t("./abort-controller")),
                c = "Airtable.js/" + i.default;
              e.exports = function t(e, r, n, i, l, f, d) {
                var p =
                    e._airtable._endpointUrl +
                    "/v" +
                    e._airtable._apiVersionMajor +
                    "/" +
                    e._id +
                    n +
                    "?" +
                    a.default(i),
                  h = {
                    authorization: "Bearer " + e._airtable._apiKey,
                    "x-api-version": e._airtable._apiVersion,
                    "x-airtable-application-id": e.getId(),
                    "content-type": "application/json",
                  };
                "undefined" != typeof window
                  ? (h["x-airtable-user-agent"] = c)
                  : (h["User-Agent"] = c);
                var _ = new u.default(),
                  b = r.toUpperCase(),
                  y = { method: b, headers: h, signal: _.signal };
                null !== l &&
                  ("GET" === b || "HEAD" === b
                    ? console.warn(
                        "body argument to runAction are ignored with GET or HEAD requests",
                      )
                    : (y.body = JSON.stringify(l)));
                var v = setTimeout(function () {
                  _.abort();
                }, e._airtable._requestTimeout);
                s.default(p, y)
                  .then(function (a) {
                    if (
                      (clearTimeout(v),
                      429 !== a.status || e._airtable._noRetryIfRateLimited)
                    )
                      a.json()
                        .then(function (t) {
                          var r = e._checkStatusForError(a.status, t),
                            n = {};
                        ...
                        .catch(function () {
                          f(e._checkStatusForError(a.status));
                        });
                    else {
                      var s = o.default(d);
                      setTimeout(function () {
          ...
          17: [
            function (t, e, r) {
              ...
              var n =
                ...
                a = o(t("lodash/isPlainObject")),
                i = o(t("./deprecate")),
                s = o(t("./query")),
                u = t("./query_params"),
                c = o(t("./object_to_query_param_string")),
                l = o(t("./record")),
                f = o(t("./callback_to_promise")),
                d = (function () {
                  function t(t, e, r) {
                    if (!e && !r)
                  ...
                  return (
                            ...
                            t
                              ...
                              : ((o = i
                                  ? n.records.map(function (t) {
                                      return new l.default(a, t.id, t);
                                    })
                                  : new l.default(a, n.id, n)),
                                r(null, o));
                          },
                        ));
                    }),
                    (t.prototype._updateRecords = function (t, e, r, o, i) {
                      var s,
                        u = this;
                      if (Array.isArray(e)) {
                        var c = e;
                        ((s = a.default(r) ? r : {}), (i = o || r));
                        var f = t ? "put" : "patch",
                          d = n({ records: c }, s);
                        this._base.runAction(
                          f,
                        ...
                        var p = e,
                          h = r;
                        ((s = a.default(o) ? o : {}), (i = i || o));
                        var _ = new l.default(this, p);
                        t ? _.putUpdate(h, s, i) : _.patchUpdate(h, s, i);
                      }
                    }),
                        ...
                        this._base.runAction(
                          ...
                          function (t, n, o) {
                            if (t) e(t);
                              ...
                              var a = o.records.map(function (t) {
                                var e = t.id;
                                return new l.default(r, e, null);
                              });
                              e(null, a);
                            }
                          },
                        );
                      } else new l.default(this, t).destroy(e);
                    }),
                    (t.prototype._listRecords = function (t, e, r, o) {
                      var a = this;
                      o || ((o = r), (r = {}));
                      var i,
                        s,
                        f =
                          "/" + this._urlEncodedNameOrId() + "?" + c.default(r),
                        d = {},
                        p = null;
                      if (
                        ...
                        ((i =
                          "/" + this._urlEncodedNameOrId() + "/listRecords"),
                          (p = n(
                            n({}, t && { pageSize: t }),
                            e && { offset: e },
                          )),
                          (s = "post"));
                        for (var h = 0, _ = Object.keys(r); h < _.length; h++) {
                          var b = _[h];
                          u.shouldListRecordsParamBePassedAsParameter(b)
                            ? (d[b] = r[b])
                            : (p[b] = r[b]);
                        }
                      } else
                        ((s = "get"),
                          (i = "/" + this._urlEncodedNameOrId() + "/"),
                          (d = n({ limit: t, offset: e }, r)));
                      this._base.runAction(s, i, d, p, function (t, e, r) {
                        if (t) o(t);
                        else {
                          var n = r.records.map(function (t) {
                            return new l.default(a, null, t);
                          });
                          o(null, n, r.offset);
                        }
                      });
                    ...
                    (t.prototype._forEachRecord = function (e, r, n) {
                      ...
                      var a = t.__recordsPerPageForIteration || 100,
                        i = null,
                        s = function () {
                          o._listRecords(a, i, e, function (t, e, o) {
                            if (t) n(t);
                            else {
                    ...
                    return (
                      ...
                      (t = (function (t, e) {
                        return !e ||
                          ...
                          ? u(t)
                          : e;
                      })(this, i(e).call(this))).listeners || l.call(u(t)),
                      ...
                      },
                      {
                        ...
                        value: function (t) {
                          ("abort" === t.type &&
                            ...
                            c(i(e.prototype), "dispatchEvent", this).call(
                              this,
                              t,
                            ));
                        },
              ...
              ("undefined" != typeof Symbol &&
                ...
                (r.abortableFetch = function (t) {
                  ...
                  var e = t,
                    ...
                    a = e.AbortController,
                    i = e.__FORCE_INSTALL_ABORTCONTROLLER_POLYFILL,
                    s = void 0 !== i && i;
                  if (
                    !(function (t) {
          ...
          32: [
            function (t, e, r) {
              ...
              e.exports = function (t) {
                return !(!a(t) || o(t)) && (n(t) ? d : s).test(i(t));
              };
            },
            {
              "./_isMasked": 54,
            ...
            function (t, e, r) {
              var n = t("./_baseIsArguments"),
                ...
                u = n(
                  ...
                  : function (t) {
                      return (
                        o(t) && i.call(t, "callee") && !s.call(t, "callee")
                      );
                    };
              e.exports = u;
            },
          ...
          86: [
            function (t, e, r) {
              ...
              e.exports = function (t) {
                return (
                  "number" == typeof t || (o(t) && "[object Number]" == n(t))
                );
              };
            },
            { "./_baseGetTag": 30, "./isObjectLike": 88 },
                ...
                u = (function () {
                  function t(e) {
                    ...
                    if (
                      (Object.defineProperties(this, {
                        ...
                        _endpointUrl: {
                          value:
                            e.endpointUrl || t.endpointUrl || r.endpointUrl,
                        },
                  ...
                  return (
                    (t.prototype.base = function (t) {
                      return o.default.createFunctor(this, t);
                    }),
                    ...
                    (t.configure = function (e) {
                      var r = e.apiKey,
                        n = e.endpointUrl,
                        o = e.apiVersion,
                        a = e.noRetryIfRateLimited,
                        i = e.requestTimeout;
                      ((t.apiKey = r),
                        (t.endpointUrl = n),
                        (t.apiVersion = o),
                        (t.noRetryIfRateLimited = a),
                        (t.requestTimeout = i));
                    }),
                    (t.base = function (e) {
                      return new t().base(e);
